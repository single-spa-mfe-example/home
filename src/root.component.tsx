        ...
        <div className="hero-body">
          <div className="container is-widescreen has-text-left">
            <p className="title">
              ...
              eum, nemo commodi ipsam ratione beatae dolorem rerum accusamus,
              iste odio, quia minus nisi? Enim, corrupti. Voluptate tenetur
              pariatur perspiciatis aut.
            </p>
            <p className="subtitle">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enim
              accusamus amet, expedita magnam, quidem excepturi assumenda
              impedit iusto voluptatem dicta pariatur sed officiis molestias,
              numquam quis. Sunt, delectus! Asperiores, neque.
            </p>
          </div>
        </div>
      </section>
